...
Event OnContainerChanged(ObjectReference akNewContainer, ObjectReference akOldContainer)
    if(akNewContainer == PlayerRef) ;if player looted it
        ...
        if ItemSwapper.LootedUnkStackUnits == 1 ; looted one unit, not a stack of unidentified items
        ...
        elseif ItemSwapper.LootedUnkStackUnits > 1 ;looted a stack
            ...
            while i < ItemSwapper.LootedUnkStackUnits ; travel the whole looted stack
                ...
                i+=1
            endwhile
            ItemSwapper.NTotalLootedItems+=ItemSwapper.LootedUnkStackUnits
        endif
